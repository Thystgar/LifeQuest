...
import { fetchQuests, completeQuest, addQuest } from '../shared/api';
import { createQuest, Quest, QuestStatus } from '../shared/types';

export default function QuestsTab() {
  const [quests, setQuests] = useState<Quest[]>([]);
  const [modalVisible, setModalVisible] = useState(false);
  const [quest, setQuest] = useState<Quest | null>(createQuest());
